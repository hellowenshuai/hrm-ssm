...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td>
				<form
					action="${pageContext.request.contextPath}/employee/modifyEmployee.do"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									...
									<tr>
										...
										<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input
											name="tel" id="tel" size="20" value="${employee.tel }" /></td>
									</tr>
						...
						<tr>
							<td class="font3 fftd">出生日期：<input cssClass="Wdate"
								...
								name="birthday" id="birthday"  value="<f:formatDate  pattern="yyyy-MM-dd" value="${employee.birthday}" 
								type="date" dateStyle="long"/>" <%-- value="${employee.birthday}" --%> size="40" />&nbsp;&nbsp;
								民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="race" id="race"
								size="20" value="${employee.race }" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
