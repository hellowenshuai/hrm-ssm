...
<html>
	<head>
		...
		function addDocument() {
        	...
        	$.post("${pageContext.request.contextPath }/document/addDocument.do",
    				$("#documentForm").serialize(),function(data){
    			if(data == "OK"){
    				alert("文件上传成功！");
    				window.location.href="${pageContext.request.contextPath }/document/findDocument.do";
				 ...
				 <form id="documentForm" name="documentForm" action="${pageContext.request.contextPath }/document/addDocument.do" enctype="multipart/form-data" method="post">
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr><td class="font3 fftd">
								...
								<input type="reset" value="重置" onclick="javascript:history.back(-1);" >
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
